...
export default function FormStep4({ register, watch, setValue, errors, back, isSubmitting }) {
  ...
  return (
    <>
      <div className="borderGreen rounded-4 mb-3 p-4">
        ...
        <p>El proponente, que se presente de manera individual o como estructura plural, bajo la gravedad de juramento, declara:</p>
        <ul>
          <li className="mb-2">Que los datos e información contenidos en este formato son veraces y susceptibles de verificación.</li>
          <li className="mb-2">Que ha leído y acepta la totalidad de los términos, condiciones y procedimientos establecidos en el reglamento de la subasta...</li>
        </ul>
